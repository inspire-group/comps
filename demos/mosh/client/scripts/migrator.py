...
class MigratorThread(threading.Thread):
  ...
  def run(self):
    ...
    while not self._stopevent.isSet():
      ...
      try:
        self._ip.route("del", dst="10.0.0.1", dst_len=32, table=254, rtscope="RT_SCOPE_LINK")
      except:
        print("MigratorThread: No such ip route currently exists.")
      self._ip.route("add", dst="10.0.0.1", dst_len=32, table=254, rtscope="RT_SCOPE_LINK",
